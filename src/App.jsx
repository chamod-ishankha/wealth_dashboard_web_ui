  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <main className="min-h-screen bg-minimal-grid bg-[length:24px_24px]">
        ...
        {isFormOpen ? (
          <div
            className="fixed inset-0 z-50 bg-slate-900/40 backdrop-blur-sm overflow-y-auto flex items-center justify-center p-4"
            onClick={() => setIsFormOpen(false)}
          >
            <div
              className="relative bg-white w-full sm:max-w-xl md:max-w-2xl mx-auto rounded-2xl p-6 sm:p-8 shadow-xl my-auto max-h-[85vh] overflow-y-auto sm:max-h-[90vh] flex flex-col"
